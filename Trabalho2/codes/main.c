...
int main() {
    ...
    if (num1 == 1){
        ...
        scanf("%s", a1); //nome do arquivo binario
        funcionalidade8(a1); //chama funcionalidade 8
    } 
    else if(num1==9){
        scanf("%s", a1); //nome do arquivo binario
        funcionalidade9(a1); //chama funcionalidade 9
    } 
    else if(num1==10){
        scanf("%s %d", a1, &n); //nome do arquivo binario
        funcionalidade10(a1, n); //chama funcionalidade 10
    } 
    else if(num1==11){
        scanf("%s", a1); //nome do arquivo binario
        funcionalidade11(a1); //chama funcionalidade 10
    }
    else if(num1==12){
        scanf("%s %d", a1, &n); //nome do arquivo binario e a quantidade de vezes que a funcionalidade deve ser realizada
        funcionalidade12(a1, n); //chama funcionalidade 12
    }
